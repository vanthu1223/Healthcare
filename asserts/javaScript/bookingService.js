  ...
  fetch(`http://localhost:3000/services/${id}`, {
    ...
    .then((data) => {
      ...
      const html4 = `
          ...
          <div class="col-sm-5">
              <img src="${data.img}" alt="ảnh" width="100%" style="border-radius: 10px;margin-top:10px;">
          </div>
          <div class="col-sm-5">
              <h2 style="font-weight: bold; font-size: 20px;color:  #FF6A88;" id="nameService">${data.name}</h2>
